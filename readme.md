# download-directory <img src="logo.svg" width="50" height="50" align="left">

> Download just a sub directory from a GitHub repo

This is a fork of [download-directory.github.io](https://github.com/download-directory/download-directory.github.io) hosted at [friday-platform.github.io/download-directory](https://friday-platform.github.io/download-directory/).
...
[**friday-platform.github.io/download-directory**`?url=https://github.com/mrdoob/three.js/tree/dev/build`](https://friday-platform.github.io/download-directory/?url=https://github.com/mrdoob/three.js/tree/dev/build)

You can also specify download filename by adding `filename` parameter, like:

[**friday-platform.github.io/download-directory**`?url=https://github.com/mrdoob/three.js/tree/dev/build&filename=three-js-build`](https://friday-platform.github.io/download-directory/?url=https://github.com/mrdoob/three.js/tree/dev/build&filename=three-js-build) to save the file as **three-js-build.zip**.
